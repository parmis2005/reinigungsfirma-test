      ...
      <div className="relative max-w-7xl mx-auto px-4 w-full">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative hidden lg:block">
            ...
            {/* ISO badge */}
            <div className="absolute top-4 left-4 bg-white rounded-xl shadow-xl p-3 flex items-center gap-2.5 border border-gray-100 max-w-[320px]">
              <div className="w-10 h-10 bg-primary-50 rounded-lg flex items-center justify-center shrink-0">
                <Shield className="text-primary-600" size={20} />
              </div>
              <div>
                <div className="font-bold text-gray-800 text-xs sm:text-sm leading-tight">ISO 9001 Zertifiziert</div>
                <div className="text-gray-500 text-[11px] sm:text-xs leading-tight">Betriebshaftpflicht 5 Mio. €</div>
              </div>
            </div>

            {/* Rating badge */}
            <div className="absolute bottom-4 right-4 bg-accent-400 rounded-xl shadow-xl p-3 text-white text-center">
              <div className="text-2xl font-black leading-none">4.9</div>
              <div className="flex justify-center gap-0.5 my-1">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-2.5 h-2.5 fill-white" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                ))}
              </div>
              <div className="text-[10px] text-white/80">Google Bewertung</div>
            </div>
          </div>
        </div>
      </div>
